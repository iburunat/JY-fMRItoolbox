...
%
% References:
%   Lancaster, J.L. et al. (2007). Bias between MNI and Talairach coordinates
%   analyzed using the ICBM-152 brain template. Human Brain Mapping, 28(11),
%   1194-1205.
%
% See also: fmri_sub2mni, fmri_mni2sub

mni = mni(:);
A   = [.88 0 0; 0 .97 0; 0 .05 .88];
B   = [-.8; -3.32; -.44];
tal = A * mni + B;
