function g = fmri_doublegamma(t, d1, d2, c)
...
%
% See also: fmri_corregressor, fmri_wiener

if nargin<4 c=.35; end
if nargin<3 d2=12; end
if nargin<2 d1=6; end


t1=.9*d1;
t2=.9*d2;
g = (t/t1).^d1.*exp(-d1*(t-t1)/t1)-c*(t/t2).^d2.*exp(-d2*(t-t2)/t2);
